...
@section('content')
    ...
    <div class="content" style="background-color: #CFC9C9">
        <h3 style="color:#463F3A"><strong>About</strong></h3>
        <hr style="background-color: #A95237;height: 1px"><br>
        ...
        <br>
        <hr class="styled_hr">
        <h5 style="position: absolute;left: 50%;transform: translateX(-50%);color: #564F38;font-family: 'Fredoka One', cursive;font-size:x-large;font-weight: 500"><strong>Creators</strong></h5>
        <div class="about_container cr_container" style="justify-content: space-evenly;padding-top: 50px">
            <div class="creator cr1" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p><strong>second year computer science engineering student</strong></p>
            </div>
